  ...
  return (
    <div id="home" className="page">
      ...
      <div id="intro" className="flex flex-col justify-center items-center w-5/6 md:items-start md:w-2/3 lg:w-2/3 gap-y-10 sm:gap-y-14 h-full lg:h-screen">
        ...
        <p className="text-md md:text-lg w-full flex text-center md:text-left sm:w-4/5 md:w-3/4">I'm a Full Stack Developer with over 4 years of experience and expertise.</p>
