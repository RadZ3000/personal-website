  ...
  return (
    <div id="home" className="page">
      ...
      <div id="intro" className="flex flex-col justify-center items-center w-5/6 md:items-start md:w-2/3 lg:w-2/3 gap-y-10 sm:gap-y-14 h-full lg:h-screen">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-5xl lg:text-7xl xl:text-7xl xl:leading-snug font-extrabold bg-white text-black w-max px-3"><code><span className="text-red-700">&lt;</span>HERALD<span className="text-red-700">&gt;</span></code></h1>
